...
public class ColorDialog extends AlertDialog implements OnSeekBarChangeListener, OnClickListener {
	...
	public ColorDialog(Context context, View view, int color, DrawView drawViewPath, Boolean antiAlias, String type) {
		super(context);

		Resources res = context.getResources();
		
		if(type == "brush"){
			setButton(BUTTON1, "Set Color", this);
			setTitle("Choose Brush Color");
			setButton(BUTTON3, "Cancel", this);
		}else{
			setButton(BUTTON2, "Set Canvas Color", this);
			setTitle("Set Canvas Color");
		}
		...
		checkBox = (CheckBox) root.findViewById(R.id.highres);
	...
	protected class CheckListener implements android.view.View.OnClickListener {
        ...
        public void onClick(View v) {
        	if(checkBox.isChecked()){
        		//checkBox.setChecked(false);
        		drawViewColorPath.antiAlias = true;
        	}else{
        		//checkBox.setChecked(true);
        		drawViewColorPath.antiAlias = false;
        	}
        }
   } 
	...
	public void onClick(DialogInterface dialog, int which) {
		if (which == DialogInterface.BUTTON1) {
			...
			drawViewColorPath.setColor(mColor);
		}else if (which == DialogInterface.BUTTON2) {
			Log.v("BG COLOR","BG COLOR: "+mColor);
			drawViewColorPath.SetBGColor(mColor);
		}
		dismiss();
	}
